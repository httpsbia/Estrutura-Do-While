...
public class L04D {
	public static void main (String []args) {
		...
		while (cont <= 64) {
			System.out.println("No quadrado " + cont + " teremos " + quadrado + " grãos.");
		...
		System.out.println("A soma do número de grãos que se pode obter num tabuleiro de xadrez é: " + soma);
	}
